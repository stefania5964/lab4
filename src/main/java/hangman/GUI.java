...
public class GUI {
    ...
    public GUI(HangmanFactoryMethod factoryMethod) {
        ...
        this.scoreModel = factoryMethod.createOriginalScore();
    }

    @Inject
    // Use Guice constructor
    public GUI(Language language, HangmanDictionary dictionary, HangmanPanel hangmanPanel, GameScore scoreModel){
    ...
    private void setup(){
        ...
        GameModel gameModel = new GameModel(dictionary,scoreModel);
